...
import decimal, calendar, pytz, datetime
estados_venezuela = [
    {
        "iso_31662": "VE-X",
        "estado": "Amazonas",
...
class Country():
	...
	def get_country_list(self):
		country_list = [ country for (country, data) in self.countries.iteritems()]
		return country_list
	def get_state_list(self, country):
		state_list = [estado['nombre'] for estado in self.countries[country]['estados']]
		return state_list
	def get_municipio_list(self, country, estado):
		municipio_list = [estado['nombre'] for estado in self.countries[country]['estados'][estado]]
		return municipio_list
	def get_parroquia_list(self, country, estado, municipio):
		parroquia_list = [estado['nombre'] for estado in self.countries[country]['estados'][estado]['municipios'][municipio]]
		return parroquia_list
